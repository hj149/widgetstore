...
foreach(range(1, 10) as $i) {
    array_push($videos, array(
        "title" => "凤凰浴火我是传奇凤凰传奇是传奇凤凰是传奇凤凰传奇是传奇凤凰传奇是传奇 凤凰传奇传奇是传奇 凤凰传奇北京工体演唱会实录",
        "s_intro" => "sdfdsfsadfsdfsadfsafasdfsadfsfdasadfsafdsadfsfa凰传奇是传奇 凤凰传奇凰传奇北京工体演",
    ...
    array_push($videos, array(
        "title" => "凤凰sdfsdf浴火凤凰sdfsfs火凤凰浴sfdsafddsf火是传奇 凤凰传奇是传奇 凤凰传奇是传奇 凤凰传奇是传奇 凤凰传奇凤凰浴火凤凰浴火凤凰浴火",
...
$xiuchang_data = array(
    ...
    "videos" => array(
        ...
        array(
            "title" => "凤凰浴火凤凰浴火凤凰浴是传奇 凤凰传奇是传奇 凤凰传奇是传奇 凤凰传奇是传奇 凤凰传奇火凤凰浴火凤凰浴火凤凰浴火凤凰浴火",
        ...
        array(
            ...
            "s_intro" => "你好爱你好爱你好爱你好是传奇 凤凰传奇是传奇 凤凰传奇是传奇 凤凰传奇爱你好爱你好爱你好爱你好爱",
            "url" => "http://v.baidu.com",
            "imgh_url" => "http://img0.bdstatic.com/img/image/shouye/lyngaomen.jpg",
            "imgv_url" => "http://hejie.baidu.com:8081/static/v3/fashion/page/test/img1.jpg",
            "hot_week" => "347",
...
$fis_data = array(
    ...
    //焦点大图
    "page_name" => "index",
    "fashion_focus" => $test_data,
    "fashion_meizhuang_main" => $test_data,
    "fashion_meizhuang_side" => $test_data,
    "fashion_xiuchang_main" => $xiuchang_data,
    "fashion_xiuchang_side" => $test_data,
    "fashion_yuanchuang_main" => $test_data,
    "fashion_yuanchuang_side" => $test_data,
    "fashion_mingjia_main" => $test_data,
    "fashion_mingjia_side" => $test_data,
    "fashion_jujiao_main" => $test_data,
    "fashion_jujiao_side" => $test_data
);